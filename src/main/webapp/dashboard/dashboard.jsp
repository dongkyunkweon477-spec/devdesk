  ...
  <style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    body::before {
      ...
      inset: 0;
      background-image:
        linear-gradient(rgba(91,124,248,0.025) 1px, transparent 1px),
    ...
    .stage-chip:hover { border-color: var(--chip-color, var(--accent)); transform: translateY(-2px); }
    .stage-chip:hover::after { opacity: 1; }

    .stage-chip-icon  { font-size: 20px; }
    .stage-chip-name  { font-size: 10px; color: var(--text3); text-align: center; }
    .stage-chip-count { font-size: 22px; font-weight: 700; color: var(--chip-color, var(--text)); line-height: 1; }
    .stage-chip-unit  { font-size: 10px; color: var(--text3); margin-top: -4px; }
    ...
    .funnel-fill {
      height: 100%;
      border-radius: 4px;
      /* 실제 너비는 JSP에서 style="width:${pct}%" 로 주입 */
    }
    ...
    .sch-row:hover { border-color: rgba(91,124,248,0.3); transform: translateX(2px); }
    ...
    .sch-date { text-align: center; min-width: 36px; }
    .sch-mon  { font-size: 9px; color: var(--text3); text-transform: uppercase; }
    .sch-day  { font-size: 20px; font-weight: 700; color: var(--text); line-height: 1.1; }

    .sch-vline { width: 1px; background: var(--border); align-self: stretch; margin: 1px 0; }

    .sch-info  { flex: 1; }
    .sch-company { font-size: 13px; font-weight: 500; color: var(--text); }
    .sch-time    { font-size: 11px; color: var(--text3); margin-top: 1px; }
    ...
    .til-row:hover { background: var(--surface2); border-color: var(--border); }

    .til-num   { font-size: 11px; color: var(--text3); width: 18px; text-align: right; }
    .til-dot   { width: 7px; height: 7px; border-radius: 50%; flex-shrink: 0; }
    .til-info  { flex: 1; min-width: 0; }
    ...
    .til-meta  { font-size: 11px; color: var(--text3); margin-top: 3px; display: flex; align-items: center; gap: 7px; }
    .til-arrow { color: var(--text3); font-size: 16px; transition: transform 0.15s; }
    .til-row:hover .til-arrow { transform: translateX(3px); color: var(--accent); }
    ...
    .donut-label { font-size: 10px; color: var(--text3); margin-top: 1px; }
    ...
    @media (max-width: 900px) {
      .content-area { margin-left: 0; padding: 20px 16px; padding-top: 72px; }
...
<div class="page-wrap">
  ...
  <main class="content-area">
    ...
    <div class="stage-strip">
      ...
      <a href="application-list?stage=CODING_TEST" class="stage-chip" style="--chip-color:#ff9f69">
        <span class="stage-chip-icon">💻</span>
        <span class="stage-chip-name">코딩테스트</span>
        <span class="stage-chip-count">${stageCounts.codingTest}</span>
        <span class="stage-chip-unit">회</span>
      </a>
